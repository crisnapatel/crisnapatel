...
<section>
  ...
  <div class="grid gap-6 md:grid-cols-2">
    <article class="rounded-2xl border border-slate-200 bg-white/70 p-6 shadow-sm">
      <h3 class="text-xl font-semibold text-brand">Hydrogen storage on graphene oxide </h3>
...
<section>
  ...
  <p>
    I maintain a collection of scripts to streamline simulation setup and analysis.
  ...
  <ul>
    ...
    <li>LAMMPS log parsers streamlit app.</li>
  </ul>
</section>
