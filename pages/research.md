...
title: Research
permalink: /research/
description: "Overview of my research at IIT Delhi."
subtitle: "Molecular simulations of carbonaceous materials, hydrogen storage, and soft matter."
---
## Research snapshot
My research uses atomistic simulation to connect local interactions, nanoscale morphology, and macroscopic performance in carbonaceous materials and soft matter systems.
- Molecular dynamics simulation of carbon allotropes for hydrogen storage: graphene, CNTs, graphane, psi-graphene, phagraphene, and graphene-CNT 3D frameworks
- Junction topology and pillar-configuration effects in pillared graphene-CNT frameworks
- Polymer-carbon interfacial dynamics: graphene effects on atactic polystyrene in toluene
- Force-field validation and model selection for carbon systems, including AIREBO/AIREBO-M and ReaxFF workflows
